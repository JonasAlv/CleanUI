...
text:SetPoint("CENTER"); text:SetText("CUI"); text:SetTextColor(1, 0.82, 0) 

button:SetHighlightTexture("Interface\\Minimap\\UI-Minimap-ZoomButton-Highlight")
button:RegisterForDrag("LeftButton"); button:RegisterForClicks("RightButtonUp"); button:SetMovable(true)
...
local function InitializeMenu(self, level)
    ...
    info = UIDropDownMenu_CreateInfo()
    info.text = ""; info.disabled = true; info.notCheckable = true
    UIDropDownMenu_AddButton(info)
